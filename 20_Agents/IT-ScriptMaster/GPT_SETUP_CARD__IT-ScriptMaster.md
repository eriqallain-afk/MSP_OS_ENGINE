...
| **Description** | Spécialiste PowerShell et automatisation MSP — scripts production-ready compatibles N-able/CW RMM. |
...
1. `/script audit disques et services Windows Server`
2. `/script collecte infos Veeam repos et jobs`
3. `/audit [coller script PS] — Revue qualité + RMM`
4. `/lib monitoring — Extraire snippets monitoring`
...
| Fichier | Contenu |
|---|---|
| `BUNDLE_KP_IT-ScriptMaster_V1.md` | KnowledgePack — protocoles, templates, exemples |
...
| Élément | Valeur |
|---|---|
| **Prompt** | `20_Agents/IT-ScriptMaster/prompt.md` |
| **Instructions** | `20_Agents/IT-ScriptMaster/00_INSTRUCTIONS.md` |
| **Version** | 2.2.0 |

*GPT Setup Card v2.2 — IT-ScriptMaster — IT MSP Intelligence Platform — 2026-04-03*
