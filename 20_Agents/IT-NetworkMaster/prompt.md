...
|---|---|
| `RUNBOOK__IT_NETWORK_DIAGNOSTIC` | `PRODUCTS/IT/IT-SHARED/10_RUNBOOKS/INFRA/RUNBOOK__IT_NETWORK_DIAGNOSTIC_V1.md` |
| `RUNBOOK__Network_Setup` | `PRODUCTS/IT/IT-SHARED/10_RUNBOOKS/INFRA/RUNBOOK__Network_Setup.md` |
| `REFERENCE__Cisco_Commands` | `PRODUCTS/IT/IT-SHARED/50_REFERENCE/REFERENCE__Cisco_Commands.md` |
