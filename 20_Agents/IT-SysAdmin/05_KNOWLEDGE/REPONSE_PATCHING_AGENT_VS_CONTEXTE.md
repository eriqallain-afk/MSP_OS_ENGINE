...
**Question:** Pour le patching, créer IT-PatchingMaster séparé OU ajouter instructions à IT-SysAdmin?

**Réponse:** ✅ **Option B - Un seul agent avec système de contextes**

---

## RECOMMANDATION: IT-SysAdmin avec Modes
...
**Tu dis:**
```
"IT-SysAdmin, je fais du patching Windows ce soir sur 3 serveurs prod"
```
...
```
IT/agents/IT-SysAdmin/02_TEMPLATES/
│
├── CONTEXTS/
│   │
│   ├── PATCHING/
...
```
User: "IT-SysAdmin, patching Windows ce soir"
...
- **Un seul agent** à retenir: IT-SysAdmin
- **Intelligence automatique:** détecte ce dont tu as besoin
- **Pas de décision:** pas besoin de choisir entre IT-PatchingMaster vs IT-SysAdmin
...
└── MAIS:
    ...
    ├── Frontière floue avec IT-SysAdmin ❌
    └── Question: "maintenance régulière vs patching?" ❌
```

### Option B: IT-SysAdmin avec contextes (✅ Recommandé)
...
✅ **Structure créée:**
```
IT-SysAdmin/02_TEMPLATES/CONTEXTS/
```
...
**UTILISER IT-SysAdmin avec système de contextes.**
...
```
User: "IT-SysAdmin, je prépare le patching de ce soir.
