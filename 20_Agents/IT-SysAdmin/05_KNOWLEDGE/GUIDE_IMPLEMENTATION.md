# GUIDE D'IMPLÉMENTATION - IT-SysAdmin Knowledge Pack

## Vue d'ensemble

Ce Knowledge Pack transforme IT-SysAdmin en assistant opérationnel qui:
...
**Fichiers à uploader pour IT-SysAdmin:**

1. **Knowledge Pack complet:**
   - Tous les fichiers de IT-SysAdmin_KnowledgePack_v1/

2. **Fichiers core:**
   - prompt.md (de PRODUCTS/IT/agents/IT-SysAdmin/)
   - agent.yaml
   - contract.yaml
...
Tu as accès à un Knowledge Pack dans `IT-SysAdmin_KnowledgePack_v1/`:
...
*Guide version 1.0 - IT-SysAdmin Knowledge Pack*
