# Donnees de Reference - IT-SysAdmin

## Description

Ce dossier centralise toutes les **donnees de reference statiques** utilisees par IT-SysAdmin pour prendre des decisions et produire ses livrables.
...
*Reference Data - IT-SysAdmin v1.0*
