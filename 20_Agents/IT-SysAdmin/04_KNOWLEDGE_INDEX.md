# Knowledge Index — IT-SysAdmin (v3.0)
...
| `BUNDLE_KP_SysAdmin_V1.md` | `IT-SHARED/60_BUNDLES/` | 🔴 Critique |
...
| `IT-SysAdmin__KnowledgePack_Supplement_v1.md` | Supplément Knowledge Pack |
...
*Index v3.0 — 2026-03-22 — IT-SysAdmin*
