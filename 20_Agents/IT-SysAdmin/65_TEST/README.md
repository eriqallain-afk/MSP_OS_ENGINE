# Zone de Test et Validation - IT-SysAdmin

## Description

Ce dossier est la **zone de QA et de validation** de IT-SysAdmin. Il contient les scenarios de test, les resultats d'execution et les rapports de conformite.
