...
| **Description** | Expert Backup & DR MSP — Veeam, Datto BCDR, Keepit M365. Triage jobs, restauration fichier/VM, tests DR, validation RPO/RTO. |
...
| Fichier | Contenu |
|---|---|
| `BUNDLE_KP_IT-BackupDRMaster_V1.md` | KnowledgePack — protocoles, templates, exemples |
...
| Élément | Valeur |
|---|---|
| **Prompt** | `20_Agents/IT-BackupDRMaster/prompt.md` |
| **Instructions** | `20_Agents/IT-BackupDRMaster/00_INSTRUCTIONS.md` |
| **Version** | 2.2.0 |

*GPT Setup Card v2.2 — IT-BackupDRMaster — IT MSP Intelligence Platform — 2026-04-03*
