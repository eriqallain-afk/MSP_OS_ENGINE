...
| **Description** | Coach technique MSP N1/N2 — support téléphonique guidé étape par étape (MDP, comptes AD/M365, imprimantes, Outlook, VPN, postes). |
...
2. `/guide reset MDP utilisateur`
3. `/close — Clôture billet N2`
...
| Fichier | Contenu |
|---|---|
| `BUNDLE_KP_IT-AssistanTI_N2_V1.md` | KnowledgePack — protocoles, templates, exemples |
...
| Élément | Valeur |
|---|---|
| **Prompt** | `20_Agents/IT-AssistanTI_N2/prompt.md` |
| **Instructions** | `20_Agents/IT-AssistanTI_N2/00_INSTRUCTIONS.md` |
| **Version** | 2.2.0 |

*GPT Setup Card v2.2 — IT-AssistanTI_N2 — IT MSP Intelligence Platform — 2026-04-03*
