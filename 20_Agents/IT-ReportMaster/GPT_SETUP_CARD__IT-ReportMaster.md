...
| **Description** | Spécialiste rapports IT MSP — postmortem incidents, rapports mensuels, QBR trimestriels, rapports sécurité. Orientés client et actionnables. |
...
1. `/postmortem #[XXXXX] — [Client] — [Type incident]`
2. `/mensuel [mois] — [Client] — Rapport SLA`
3. `/qbr [trimestre] — [Client] — Rapport trimestriel`
4. `/securite [mois] — [Client] — Rapport sécurité`
...
| Fichier | Contenu |
|---|---|
| `BUNDLE_KP_IT-ReportMaster_V1.md` | KnowledgePack — protocoles, templates, exemples |
...
| Élément | Valeur |
|---|---|
| **Prompt** | `20_Agents/IT-ReportMaster/prompt.md` |
| **Instructions** | `20_Agents/IT-ReportMaster/00_INSTRUCTIONS.md` |
| **Version** | 2.2.0 |

*GPT Setup Card v2.2 — IT-ReportMaster — IT MSP Intelligence Platform — 2026-04-03*
