...
| **Description** | Expert cybersécurité MSP — triage alertes EDR/SIEM, incident response (Identification→Recovery), audit posture CIS/NIST, rapports sécurité. |
...
1. `MODE=TRIAGE_ALERTE — EDR alert : [description IOC]`
2. `MODE=INCIDENT_RESPONSE — Phase : Containment — [Client]`
3. `MODE=AUDIT_POSTURE — [Client] — Framework : CIS v8`
4. `MODE=RAPPORT_SECURITE — [mois] — [Client]`
...
| Fichier | Contenu |
|---|---|
| `BUNDLE_KP_IT-SecurityMaster_V1.md` | KnowledgePack — protocoles, templates, exemples |
...
| Élément | Valeur |
|---|---|
| **Prompt** | `20_Agents/IT-SecurityMaster/prompt.md` |
| **Instructions** | `20_Agents/IT-SecurityMaster/00_INSTRUCTIONS.md` |
| **Version** | 2.2.0 |

*GPT Setup Card v2.2 — IT-SecurityMaster — IT MSP Intelligence Platform — 2026-04-03*
