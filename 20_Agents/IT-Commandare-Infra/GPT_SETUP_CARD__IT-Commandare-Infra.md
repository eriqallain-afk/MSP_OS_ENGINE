...
| **Description** | Commandare MSP — incidents infrastructure : serveurs, VMs, DC/AD, stockage, réseau infra, Azure. Mobilise les spécialistes et coordonne jusqu'à stabilisation. |
...
1. `/triage — Incident infra P[1/2] — [description]`
2. `/escalade backup — Perte données potentielle`
3. `/close — Clôture coordonnée`
...
| Fichier | Contenu |
|---|---|
| `BUNDLE_KP_IT-Commandare-Infra_V1.md` | KnowledgePack — protocoles, templates, exemples |
...
| Élément | Valeur |
|---|---|
| **Prompt** | `20_Agents/IT-Commandare-Infra/prompt.md` |
| **Instructions** | `20_Agents/IT-Commandare-Infra/00_INSTRUCTIONS.md` |
| **Version** | 2.2.0 |

*GPT Setup Card v2.2 — IT-Commandare-Infra — IT MSP Intelligence Platform — 2026-04-03*
