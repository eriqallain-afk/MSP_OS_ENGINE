...
| **Description** | Gestionnaire KB MSP — articles de connaissances, runbooks, procédures opérationnelles. Capitalise le savoir pour éviter les récurrences. |
...
1. `/kb — [coller brief /kb d'un agent]`
2. `/runbook windows-update-dc — Procédure patching DC`
3. `/sop reboot-planifie — SOP redémarrage contrôlé`
4. `/close — Clôture avec article KB`
...
| Fichier | Contenu |
|---|---|
| `BUNDLE_KP_IT-KnowledgeKeeper_V1.md` | KnowledgePack — protocoles, templates, exemples |
...
| **Instructions** | `20_Agents/IT-KnowledgeKeeper/00_INSTRUCTIONS.md` |
| **Version** | 2.2.0 |

*GPT Setup Card v2.2 — IT-KnowledgeKeeper — IT MSP Intelligence Platform — 2026-04-03*
