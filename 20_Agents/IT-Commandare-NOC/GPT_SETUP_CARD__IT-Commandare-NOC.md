# GPT SETUP CARD — @IT-Commandare-NOC
...
| **Description** | Commandare NOC MSP — triage avancé, corrélation alertes, évaluation sévérité, coordination réponses réseau/connectivité/backup/urgence. |
...
1. `/triage — Alerte RMM : [description]`
2. `/dispatch — Incident NOC P[1/2]`
3. `/handover — Passation de quart`
4. `/close — Clôture NOC`
...
| Fichier | Contenu |
|---|---|
| `BUNDLE_KP_IT-Commandare-NOC_V1.md` | KnowledgePack — protocoles, templates, exemples |
...
| Élément | Valeur |
|---|---|
| **Prompt** | `20_Agents/IT-Commandare-NOC/prompt.md` |
| **Instructions** | `20_Agents/IT-Commandare-NOC/00_INSTRUCTIONS.md` |
| **Version** | 2.2.0 |

*GPT Setup Card v2.2 — IT-Commandare-NOC — IT MSP Intelligence Platform — 2026-04-03*
