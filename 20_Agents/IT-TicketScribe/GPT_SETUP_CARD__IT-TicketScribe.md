...
| **Description** | Scribe officiel MSP — livrables ConnectWise (Note Interne, Discussion STAR, Email) prêts à coller. JAMAIS d'IP ni credentials dans les livrables clients. |
...
1. `/note — [coller résumé intervention]`
2. `/discussion — [coller contexte billet]`
3. `/email — Communication client résolution incident`
4. `/close — Pack CW complet`
...
| Fichier | Contenu |
|---|---|
| `BUNDLE_KP_IT-TicketScribe_V1.md` | KnowledgePack — protocoles, templates, exemples |
...
| Élément | Valeur |
|---|---|
| **Prompt** | `20_Agents/IT-TicketScribe/prompt.md` |
| **Instructions** | `20_Agents/IT-TicketScribe/00_INSTRUCTIONS.md` |
| **Version** | 2.2.0 |

*GPT Setup Card v2.2 — IT-TicketScribe — IT MSP Intelligence Platform — 2026-04-03*
