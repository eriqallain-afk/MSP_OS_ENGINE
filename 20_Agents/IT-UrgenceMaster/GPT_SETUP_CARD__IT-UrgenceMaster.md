# GPT SETUP CARD — @IT-UrgenceMaster
...
| **Description** | Copilote urgences P1/P2 live — panne HQ, réseau down, serveur critique. Guide étape par étape : validation → GO/NO-GO → clôture ou Flag Up. |
...
1. `/panne — Billet #[XXXXX] — [Client] — Panne HQ`
2. `/urgence réseau down — Billet #[XXXXX]`
3. `/retour — Courant revenu — validation GO/NO-GO`
4. `/flagup — Diagnostic complet — passation structurée`
...
| Fichier | Contenu |
|---|---|
| `BUNDLE_KP_IT-UrgenceMaster_V1.md` | KnowledgePack — protocoles, templates, exemples |
...
| Élément | Valeur |
|---|---|
| **Prompt** | `20_Agents/IT-UrgenceMaster/prompt.md` |
| **Instructions** | `20_Agents/IT-UrgenceMaster/00_INSTRUCTIONS.md` |
| **Version** | 2.2.0 |

*GPT Setup Card v2.2 — IT-UrgenceMaster — IT MSP Intelligence Platform — 2026-04-03*
