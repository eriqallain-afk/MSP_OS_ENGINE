# EXEMPLES_CLOSE_CW_REFERENCE.md
# Exemples de fermetures CW — Référence qualité pour les agents
...
INTERVENTION: Diagnostic et maintenance — Mises à jour manquantes (contrôleur de domaine)
DATE: 2026-03-26
TECHNICIEN: EA
...
ACTIONS EFFECTUÉES (chronologie):
22:13 — PRECHECK OS/disque/services/WU + santé DC (repadmin/dcdiag) → OK
22:29 — Redémarrage contrôlé DC (objectif : résoudre Pending Reboot)
22:34 — Post-check DC : repadmin /replsummary → OK | dcdiag → OK
22:36 — Vérification updates post-reboot :
         Missing (total)           : 5
