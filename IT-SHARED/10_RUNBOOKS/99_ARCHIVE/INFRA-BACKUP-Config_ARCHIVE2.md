# RUNBOOK — CONFIGURATION BACKUP MSP
**Agents :** @IT-BackupDRMaster, IT-MaintenanceMaster, IT-SysAdmin
**Scope :** Veeam, Datto, Keepit — configuration initiale et validation
