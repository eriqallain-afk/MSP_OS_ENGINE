...
> Détecte automatiquement les rôles serveur et adapte les checks en conséquence.
...
> Même script PRECHECK_POSTCHECK_V3.ps1 — passer le paramètre `POST`.
...
- [ ] Uptime remis à zéro
- [ ] Flags pending reboot effacés (CBS · WU · PFR)
- [ ] Services automatiques tous Running
- [ ] Event Log propre (aucune erreur/critique)
- [ ] Rôles spécifiques : DC (réplication) · SQL (instances) · RDS (sessions disponibles)
