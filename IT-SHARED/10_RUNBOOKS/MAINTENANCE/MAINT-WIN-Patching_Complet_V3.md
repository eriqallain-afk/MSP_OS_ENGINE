...
"=== Disques ==="; Get-PSDrive -PSProvider FileSystem |
    Select-Object Name, Free, @{n='FreeGB'; e={[math]::Round($_.Free/1GB,2)}} | Out-String -Width 300 | Write-Output
```
...
Get-HotFix | Where-Object {$_.InstalledOn -gt (Get-Date).AddDays(-1)} | Out-String -Width 300 | Write-Output
