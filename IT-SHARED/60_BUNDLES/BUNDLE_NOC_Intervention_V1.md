...
**Agents consommateurs :** IT-Commandare-NOC, IT-Commandare-NOCDispatcher, IT-Commandare-NOC, IT-MaintenanceMaster, IT-Assistant-N2, IT-Assistant-N3
...
IT-Commandare-NOCDispatcher ─── 1ère réception, qualification, SLA, assignation
     │
     ├─ P3/P4 ──► IT-Assistant-N2 ─── diagnostic + préparation POUR COPILOT
     │                    │
     │                    ▼
     │              IT-MaintenanceMaster ─── LIVE pendant intervention
     │                    │ /close
     │                    ▼
     │              IT-Assistant-N3 ─── closeout CW final
     │
...
| IT-Assistant-N2 | Guider diagnostic + préparer handoff | Générer CW_DISCUSSION final |
| IT-MaintenanceMaster | Assister LIVE + closeout complet | Valider architecture |
| IT-Assistant-N3 | Rédiger closeout CW (si Copilot utilisé) | Diagnostic technique |
...
- IT-Assistant-N2 → IT-[Specialist] : si domaine technique spécifique requis
